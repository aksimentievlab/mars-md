 ...
 *
 * This class manages collective operations for the given resource.
 * It supports MPI, NCCL, and ONECCL backends.
 *
 * @param res The resource.
 * @param preferred The preferred backend. Default is MPI.
 *
