...
// Generated by CMake from Unit_test/unit_test_config.h.in
#if __has_include("unit_test_config.h")
#include "unit_test_config.h"
#endif

// If not defined by CMake, fallback to a valid initializer list token (0)
#ifndef UNIT_TEST_DEVICE_ARRAY
#define UNIT_TEST_DEVICE_ARRAY 0
#endif

namespace Global {
/// GPU ids for multi-resource tests, fixed at compile time by -DUNIT_TEST_DEVICE_ARRAY=0,1,2
inline constexpr auto device_ids = std::to_array<short>({UNIT_TEST_DEVICE_ARRAY});
static_assert(!device_ids.empty(), "UNIT_TEST_DEVICE_ARRAY must list at least one id");

#ifndef UNIT_TEST_DEVICE_ID
inline constexpr short single_resource_id = device_ids[0];
#else
inline constexpr short single_resource_id = UNIT_TEST_DEVICE_ID;
#endif
} // namespace Global
